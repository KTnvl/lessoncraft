...
Return ONLY valid JSON, no markdown, no extra text:
{
  ...
  "worksheet": [
    "Question 1 about ${topic} appropriate for ${grade}",
    "Question 2 about ${topic}",
    "Question 3 about ${topic}",
    "Question 4 about ${topic}",
    "Question 5 about ${topic}"
  ],
  "differentiation": {
    "below": "Specific modified activity for below-level learners — simpler language, more scaffolding, visual supports",
    "on": "Core activity for on-level learners — standard expectations with some choice",
    "above": "Extended challenge activity for above-level learners — deeper thinking, creative application, real-world connections"
  }
}
